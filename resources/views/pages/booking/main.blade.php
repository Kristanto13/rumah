            ...
            <div class="col-lg-12">
                <div class="card mt-3">
                    <div class="card-header">
                        ...
                        <a href="javascript:;" onclick="handle_confirm('Apakah anda yakin ingin membuat data ini ?','Ya','Tidak','GET','{{route('office.booking.create')}}');"" class="btn btn-sm btn-primary" style="float:right;">
